import PathwaysAdminClient from './client';
import {
  TEST_JWT,
  TEST_APP_TOKEN,
  TEST_BASE_URL,
...
describe('Pathways client', () => {
  ...
  /**
   * These tests will need to be modified.
   * expect.objectContaining will need to be rewritten to use
   * expect.extend and a custom matcher will need to be written
   * to compare all the keys and values from the FormData.
   */
