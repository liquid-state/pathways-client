...
const pathMap: { [key: string]: string } = {
  ...
  deletePathwayIndexEvent:
    "pathways/{{pathwayId}}/index-events/{{indexEventId}}/",
  ...
  processAppUserPathway:
    "appusers/{{appUserId}}/pathways/{{appUserPathwayId}}/process/",
  transitionAppUserToPathwayStage:
    "appusers/{{appUserId}}/pathways/{{appUserPathwayId}}/transition/",
  triggerAdhocRule:
    "appusers/{{appUserId}}/pathways/{{appUserPathwayId}}/trigger_adhoc_rule/"
};
...
class PathwaysAdminClient implements IPathwaysAdminClient {
  ...
  private getUrl(
    ...
    let result;
    result = `${this.options.baseUrl}${this.buildPath(
      pathMap[endpoint],
      pathParameters
    )}${
