...
var PathwaysError = function (message) { return "Pathways Error: " + message; };
var PathwaysAPIError = function (message, response) { return ({
    message: "Pathways API Error: " + message,
    response: response,
}); };
var PathwaysClient = /** @class */ (function () {
    function PathwaysClient(jwt, options) {
        var _this = this;
        this.jwt = jwt;
        this.me = function () { return __awaiter(_this, void 0, void 0, function () {
            var url, resp, content;
    ...
    PathwaysClient.prototype.getUrl = function (endpoint) {
        var result;
        result = "" + this.options.baseUrl + pathMap[endpoint];
        return result;
    };
    PathwaysClient.prototype.sub = function () {
